...
function onload() {
  ...
  let endMarkTimer = new easyTimer(150, function (self) {
...
<main>
  ...
  >
    ...
    <canvas id="layer2" bind:this="{SCREEN}" class="game" style="position: absolute; z-index: 1;"
    ></canvas>
    <image
      id="spinner"
