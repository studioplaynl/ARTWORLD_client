...
class HistoryTracker {
  ...
  homePush(scene) {
    ...
    if (ManageSession.locationHistory[ManageSession.locationHistory.length - 1][1] == scene.location) {
        return
    } else {
        ManageSession.locationHistory.push(["DefaultUserHome", scene.location]);
    }
  }
