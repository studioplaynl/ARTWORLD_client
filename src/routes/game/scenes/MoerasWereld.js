...
export default class MoerasWereld extends Phaser.Scene {
  constructor() {
    super('MoerasWereld');
  ...
  async preload() {
    ...
    */
    ...
    const folderPath = './assets/world_swamp/';


    const loadArray = [
      {
        key: this.portalImageName, path: `${folderPath}02b_portaal_swamp_naarPaarsemainworld_400px-fs8.png`,
      },
      { key: this.backgroundImageName, path: `${folderPath}swamp_wereld_total.jpg` },
    ];
  ...
  generateLocations() {
    ...
    let locationVector = new Phaser.Math.Vector2(758, 250);
