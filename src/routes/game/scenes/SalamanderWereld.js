...
export default class SalamanderWereld extends Phaser.Scene {
  ...
  async preload() {
    ...
    this.load.image(this.portalImageName, `${folderPath}portaal_wereld21_leeg-fs8.png`);
  ...
  generateLocations() {
    ...
    let locationVector = new Phaser.Math.Vector2(-125, 1377);
