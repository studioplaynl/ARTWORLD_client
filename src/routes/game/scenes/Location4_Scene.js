...
export default class Location4Scene extends Phaser.Scene {
  ...
  async create() {
    ...
    this.add.image(200, 200, "art1").setOrigin(0).setScale(.5)
    this.add.image(600, 200, "art2").setOrigin(0).setScale(.5)
    this.add.image(1000, 200, "art3").setOrigin(0).setScale(.5)
    this.add.image(1400, 200, "background1").setOrigin(0).setScale(.5)
